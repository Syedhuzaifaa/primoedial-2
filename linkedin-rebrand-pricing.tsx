...
const linkedInDesignPlans = [
  {
    title: "Basic",
    price: "$300",
    subtitle: "/one-time",
    concepts: "1x Banner Design",
  ...
  },
  {
    ...
    price: "$800",
    subtitle: "/one-time",
    concepts: "2x Slideshows Banner",
    revisions: "Unlimited Revisions",
    features: [
      "1x Carousel Template",
      "3x Featured Cards",
      "2x Single Pager Template",
      "4-5 Days Delivery"
    ],
    highlight: true,
    primaryColor: "#01594d",
    ...
    <div className="min-h-screen relative">
      ...
      <main className="py-12 sm:py-16 px-4 sm:px-8 relative z-30">
        <div className="max-w-6xl mx-auto">
          <div className=" flex justify-center mx-auto mb-8 but_sections">
            <div className="  px-6 py-3 shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="but_t">LinkedIn Rebrand</span>
              </div>
            </div>
          </div>
          ...
          <PricingCard plans={linkedInDesignPlans} />
