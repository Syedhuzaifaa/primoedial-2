        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-green-600">
            <div className="flex flex-col space-y-4 mt-4">
              ...
              <a href="/thumbnail-design" className="hover:text-green-300 transition-colors font-medium">
                Thumbnail Design
              </a>
              <a href="#" className="hover:text-green-300 transition-colors font-medium">
                Portfolio
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-8">
            <div className="bg-white border border-gray-200 rounded-full px-6 py-3 shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-700 font-medium">Thumbnail Design</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight font-satoshi">
              <span className="text-green-500">Thumbnail</span> <span className="text-[#01594d]">Design Packages</span>
            </h1>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">3x Thumbnails Per Week</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">CTR-Based Strategy</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                  ...
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">2 Revision Per Thumbnail</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-[#01594d] font-medium">5x Thumbnails Per Week</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-[#01594d]" />
                    <span className="text-[#01594d] font-medium">CTR-Based Strategy</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-[#01594d]" />
                  ...
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-[#01594d]" />
                    <span className="text-[#01594d] font-medium">48Hrs Delivery</span>
                  </div>
                </div>
            ...
            <Card className="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 relative">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">4x Thumbnails Per Week</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">CTR-Based Strategy</span>
                  ...
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">3 Revisions Per Thumbnail</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Check className="w-5 h-5 text-green-500" />
                    <span className="text-gray-700">48Hrs Delivery</span>
