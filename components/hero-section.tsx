  ...
  return (
    <>
      ...
      <TestimonialCard
        ...
        className={`hidden lg:block absolute top-[99vh] cus-ayesha cus-card  -translate-y-1/2 w-80 bg-white shadow-xl rounded-xl transform transition-all duration-1000 ${testimonialsVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"
          } delay-20 z-40`}
        image="/images/Ellipse74.png"
    ...
    <Card className={className} >
      <CardContent className="p-2 ">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h4 className="test-h font-semibold text-[1rem] text-gray-900 font-Rethink-Sans">{name}</h4>
            <p className="test-p  text-gray-600  leading-relaxed">{text}</p>
          </div>
        </div>
      </CardContent>
    </Card>
