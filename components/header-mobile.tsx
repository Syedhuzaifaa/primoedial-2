...
export default function HeaderMobile() {
  ...
  return (
    <div className="header-class">
      <header className="bg-[#01594d] text-white px-4 mt-[1.4rem] sm:px-8 py-2 rounded-2xl mx-4 sm:mx-8 relative z-50 shadow-lg">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <img src="/images/Group 48097818.png" alt="logo" width={140} height={25} />
          </div>
          ...
          {/* Desktop CTA */}
          <a href="https://topmate.io/obeidullahsiddiqui/" target="blank" className="hidden lg:block">
            <Button className="book_button bg-green-400 hover:bg-green-500 text-black font-semibold px-6 py-2 rounded-lg shadow-md">
              Book A Call
            </Button>
          </a>
        ...
        {/* Mobile Menu (separate, no spacing issues) */}
        {isMobileMenuOpen && (
