...
export default function CheatsheetsPricing() {
 const cheatsheetDesignPlans = [
  {
    title: "Basic",
    price: "$400",
    subtitle: "/month",
    features: [
      "2x Cheatsheets Per Week",
      "Custom Designed",
      "Image Sourcing",
      "2 Revisions /Cheatsheet",
      "48Hrs Delivery"
    ],
    highlight: false,
    primaryColor: "#8ED462",
  ...
  },
  {
    ...
    subtitle: "/month",
    features: [
      "3x Cheatsheets Per Week",
      "Custom Designed",
      "Image Sourcing",
      "3 Revisions /Cheatsheet",
      "48Hrs Delivery"
    ],
    highlight: false,
    primaryColor: "#8ED462",
    ...
    <div className="min-h-screen relative">
      ...
      <main className="py-12 sm:py-16 px-4 sm:px-8 relative z-30">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mx-auto  mb-8 but_sections">
            <div className="  px-6 py-3 shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="but_t">Cheatsheets Design</span>
              </div>
            </div>
          </div>
          ...
          <PricingCard plans={cheatsheetDesignPlans} />
